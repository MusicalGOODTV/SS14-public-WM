...
public sealed partial class LatheMenu : FancyWindow
{
    ...
    public void PopulateRecipes()
    {
        ...
        var sortedWeeklyRecipesToShow = weeklyRecipesToShow.OrderBy(recipe => recipe.Name, StringComparer.Ordinal);
    ...
    private string GenerateTooltipText(WeeklyLatheRecipeData recipe)
    {
        ...
        foreach (var material in recipe.Materials)
        {
            ...
            var adjustedAmount = SharedLatheSystem.AdjustMaterial(material.Amount, true, multiplier);
            var sheetVolume = _materialStorage.GetSheetVolume(proto);
    ...
    private bool CanProduceWeeklyRecipe(WeeklyLatheRecipeData recipe, int quantity, LatheComponent? lathe)
    {
        ...
        foreach (var material in recipe.Materials)
        {
            var adjustedAmount = SharedLatheSystem.AdjustMaterial(material.Amount, true, lathe.MaterialUseMultiplier);
    ...
    public void SetQueueInfo(string? recipeId, bool isWeekly)
    {
        ...
        if (isWeekly)
        {
            var recipe = WeeklyRecipes.FirstOrDefault(recipe => recipe.RecipeId == recipeId);
    ...
    private string GetQueuedRecipeName(LatheRecipeBatch batch)
    {
        ...
        var recipe = WeeklyRecipes.FirstOrDefault(recipe => recipe.RecipeId == batch.Recipe);
    ...
    private Control GetQueuedRecipeDisplayControl(LatheRecipeBatch batch)
    {
        ...
        var recipe = WeeklyRecipes.FirstOrDefault(recipe => recipe.RecipeId == batch.Recipe);
        return GetRecipeDisplayControl(recipe);
    }
